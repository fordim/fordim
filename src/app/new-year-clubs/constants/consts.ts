...
export const MODAL_INFO_21: ModalInfo = {
  photoType: PhotoType.elf,
  title: "“+ 2 недели подписки Plus”",
  text: "Забирай подарок по",
  link: "https://skyeng-school.typeform.com/to/nCvvson5"
};
...
export const MODAL_INFO_22: ModalInfo = {
  ...
  text: "Забирай подарок по",
  link: "https://drive.google.com/drive/folders/1-aj5SXisXJDVz_1Kxqi5We50w4sKP8rZ?usp=sharing"
};
...
export const MODAL_INFO_29: ModalInfo = {
  photoType: PhotoType.elf,
  title: "“Календарь Skysmart на 2023 год”",
  text: "Забирай подарок по",
  link: "https://coda.io/d/_ds4nwCzPzv0/Skysmart-2023_suD5-"
};
...
export const MODAL_INFO_30: ModalInfo = {
  ...
  text: "Забирай подарок по",
  link: "https://youtu.be/mKw_MmtMXgA"
};

export const MODAL_INFO_31: ModalInfo = {
  photoType: PhotoType.elf,
  title: "“Дарим 4 урока в любом бонусном продукте”",
  text: "Забирай подарок по",
  link: "https://skyeng-school.typeform.com/to/HRyB46iG"
};
